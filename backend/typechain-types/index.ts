...
export type { NFTCollection } from "./contracts/nft_collection.sol/NFTCollection";
export { NFTCollection__factory } from "./factories/contracts/nft_collection.sol/NFTCollection__factory";
